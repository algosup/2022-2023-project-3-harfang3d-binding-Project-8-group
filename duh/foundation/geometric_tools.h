...
@return		False if no intersection.
*/
bool LineIntersectCone(const Vector3 &a, const Vector3 &v, const Vector3 &c, const Vector3 &d, float theta, float h, float &t0, float &t1);
...
@return		False if no intersection.
*/
bool LineIntersectAABB(const Vector3 &a, const Vector3 &v, const Vector3 &min, const Vector3 &max, float &t0, float &t1);
