...
fn test() {
	...
	assert_eq!(my_test_return_const_char_ptr(), "const char * -> string");

	let mut int_var = 9;
	assert_eq!(my_test_return_int_by_pointer(&mut int_var), 9);
	assert_eq!(my_test_return_int_by_reference(&mut int_var), 9);
