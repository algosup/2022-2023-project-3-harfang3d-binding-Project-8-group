...
def apply_api_prefix(symbol):
	'If the arg prefix is set during the call to the script, it will be used to prefix all public symbols'
...
class FABGen:
	...
	def apply_api_prefix(self, symbol):
		'Bind the Generator to the API prefix.'
